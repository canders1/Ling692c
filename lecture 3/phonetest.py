...
Evaluates a given regular expression against a given file of phone numbers.

Input: expr: a regular expression
        f: a file containing a list of phone numbers labeled as good or bad
"""
