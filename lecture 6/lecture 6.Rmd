...
<h4>Problem 3: Find all words containing a given root</h4>

Given the list of words in hobbit.txt, can you write a single line of code that returns a list of all elements containing the root 'present'?

```{python}
f = file('/Users/carolyn/Documents/UMass/CogMod/Ling692c/lecture 6/hobbit.txt','r')
print f.read().split('\n')
```
