...
<h4>Problem 2: Find the sum of the list</h4>

Given the same list, can you write a single line of code that returns the sum of all values in the list?

<h4>Problem 3: Find all words based on the root 'play'</h4>

Given the list of words in hobbit.txt, can you write a single line of code that returns a list of all elements containing the root 'play'?
